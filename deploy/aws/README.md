...
Configurar AWS localmente. Es preferible usar IAM Identity Center/SSO o un usuario IAM con permisos limitados. No usar credenciales root.
Validar la sesión:
aws sts get-caller-identity
Exportar los secretos requeridos:
