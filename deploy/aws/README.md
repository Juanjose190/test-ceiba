...
> **Nota:** estas credenciales corresponden a un ambiente temporal de evaluación y serán destruidas una vez finalice la revisión.
...
El script de despliegue configura la política de eliminación de la base de datos acoplada como `Snapshot`. Por eso, al terminar el ambiente, Elastic Beanstalk conserva un snapshot final de RDS en vez de eliminar todo silenciosamente.
